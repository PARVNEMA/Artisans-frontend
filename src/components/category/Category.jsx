...
function Category() {
  ...
  return (
    <div className="mt-4 ">
      ...
      <div className=" relative z-10 grid grid-cols-4 gap-5 mx-90 mb-10 mt-4 mx-auto aspect-w-16 aspect-h-8">
        {category.map((cat) => (
          <Link to={`/category/${cat._id}`}>
            <div className=" relative flex justify-center items-center text-center h-48 w-58 border border-black rounded-3xl shadow-md overflow-hidden mx-auto aspect-w-16 aspect-h-8 ">
              <div
