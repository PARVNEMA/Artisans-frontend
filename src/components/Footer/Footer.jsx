...
function Footer() {
    ...
    <footer class="font-[comic sans] tracking-wide px-4 py-8 bg-two">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
            ...
            <li>
              <a href="javascript:void(0)">
                <svg
                  ...
                  fill="none"
                  class="fill-white hover:opacity-50 w-7 h-7"
                  viewBox="0 0 24 24"
                >
                  <path
                    fill-rule="evenodd"
        ...
        <div class="px-15">
          <h4 class="text-white font-semibold text-2xl relative max-sm:cursor-pointer ">
            Services{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16px"
              height="16px"
              class="sm:hidden absolute right-0 top-1"
              viewBox="0 0 24 24"
            >
              <path
        ...
        <div class="px-10">
          ...
          <ul class="space-y-5 mt-6 max-sm:hidden">
            <li>
              <a href="/aboutus" class="hover:text-white text-gray-300 text-sm">
                About us
              </a>
            </li>
            <li>
      ...
      <div class="flex flex-wrap max-md:flex-col gap-4">
        <ul class="md:flex md:space-x-6 ml-36 max-md:space-y-2">
          <li>
            <a
              href="javascript:void(0)"
              class="hover:text-white text-gray-300 text-sm"
