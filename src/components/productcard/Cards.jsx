    ...
    <div className="bg-white shadow-md p-4 overflow-hidden cursor-pointer hover:-translate-y-2 transition-all relative border border-gray-200 rounded-lg">
      <div className="absolute top-3 right-3 flex space-x-2">
        <button
          ...
          className={`p-2 rounded-full z-10 bg-three hover:bg-opacity-75`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24px"
          ...
          >
            ...
            {isWishlisted && loggedIn ? (
              <path className="fill-red-600" d="M32 55.64C26.83 52.34 4 36.92 4 22.5a14.5 14.5 0 0 1 26.36-8.33 2 2 0 0 0 3.27 0A14.5 14.5 0 0 1 60 22.5c0 14.41-22.83 29.83-28 33.14Z" />
            ) : (
