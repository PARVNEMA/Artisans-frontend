		...
		<div className="bg-one min-h-screen">
			...
			<div className="flex flex-col lg:flex-row justify-between p-10 bg-four shadow-lg rounded-lg my-10 mx-4 lg:mx-20">
				<div className="lg:px-10 pt-10">
					...
					<p className="pb-4 text-3xl font-semibold text-two">
						Looking for authentic Indian products made by
						local artists? We got you.
					</p>
					<p className="text-xl font-normal text-three">
						Crafted India is a global online platform that
						helps local Indian artists connect with
						audiences both locally and internationally. We
						provide small businesses with the tools and
						support to easily launch their online shops,
						showcasing their art and make a living. We
						connect customers of Crafted India with local
						artists from across India and internationally
						with the help of Indian postal services,
						enabling them to experience the rich cultural
						heritage of India and reconnect with their
						roots.
					</p>
				</div>
			...
			<div className="flex flex-col lg:flex-row justify-between items-center my-10 mx-4 lg:mx-20 p-10 bg-white shadow-lg rounded-lg">
				...
				<div className="lg:pl-10 pt-10">
					...
					<p className="text-xl font-normal text-three">
						As local sellers/small handicrafts artisans, it
						is difficult to sell their products all around
						the globe and in India due to limited resources
						and information at their disposal. Along with
						that, artisans find it hard to form a community
						and reach people as it is difficult for them to
						understand everyone's preferences. For Indians
						living abroad, finding authentic local products
						becomes difficult due to lack of transparency in
						manufacturing and transportation of their
						desired products.
					</p>
				</div>
			</div>
			...
			<div className="flex flex-col lg:flex-row justify-between items-center my-10 mx-4 lg:mx-20 p-10 bg-white shadow-lg rounded-lg">
				<div className="lg:pl-10">
					...
					<p className="text-xl font-normal text-three">
						Crafted India along with the Indian post office
						provides artisans with a platform to identify,
						reach, and sell their products to the desired
						audiences with transparency in the
						transportation process. With our advanced
						machine learning technology, we make it easy for
						the artisans to identify their audience and form
						their own community. We connect customers with
						artisan products, ensuring a sense of security
						and support between the artisans and the
						customers.
					</p>
				</div>
				...
				<div className="grid xl:grid-cols-3 lg:grid-cols-2 gap-6">
					{[
						...
						>
							<img
								src={item.img}
								className="w-36 h-36 p-3 shrink-0 object-contain rounded-md"
								alt={item.title}
							/>
							<div>
			...
			<div className="flex justify-center py-20 bg-white shadow-lg rounded-lg mx-4 lg:mx-20">
				<div className="text-center">
					...
					<p className="text-xl font-normal text-three">
						More innovative solutions, better community
						support, and expanding our reach globally.
					</p>
				</div>
			</div>
		</div>
