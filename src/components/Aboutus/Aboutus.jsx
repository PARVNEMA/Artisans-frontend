...
//})
  ...
  return (
    <div>
        ...
        <div className="flex justify-between p-10 bg-[#0C084C]" >
            <div className=' px-40 pt-10'>
            <h1 class="text-5xl font-bold pb-4 text-two"> Crafted India</h1>
                <p class="pb-4 text-3xl font-semibold text-three"> Looking for authentic Indian products made by local artists? We got you.  </p>
                  <p class="text-xl font-normal text-three"> Crafted India is a global online platform that helps local Indian artists connect with audiences both locally and internationally. 
...
{/**Soultion to problem */}
    <div className='flex justify-between p-20'>
        <div className='px-40 pt-10 '>
        <h1 class="text-5xl font-bold pb-4  text-center"> What do we contribute </h1>
        <p> Crafted India along  with Indian post office provide Artisans  with a platefrom to  identify , reach and seller there product to the desired audiances with transparences in transpotation processs
            With our advance machine learnign technology we make it easy for the artisnas to identify there audiacne and form there own commnumity 
...
{/** two images  */}
    ...
    <div className='flex jsutify-between p-20'>
        <div className="px-40">
            <h1 class=" text-5xl font-bold pb-4 text-center"> What does the future hold for us ?</h1>
            <p>  </p>
