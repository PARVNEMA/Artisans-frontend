      ...
      <div className="w-auto h-autooverflow-hidden ">
        <div className="max-w-[1204px] gap-[46px] mx-auto flex w-full flex-col md:px-5">
          <div class="font-[comic sans]">
            {
              <div className={`${otpmodal === true ? "block" : "hidden"}`}>
                {/* You can open the modal using document.getElementById('ID').showModal() method */}

                <dialog
                  id="my_modal_3"
                  className={`modal ${
                    otpmodal === true ? "modal-open" : "hidden"
                  }`}
                >
            ...
            <div class="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] bg-white max-w-6xl max-md:max-w-lg m-4 rounded-md p-6 grid md:grid-cols-2 items-center gap-8 h-auto">
              ...
              <div class="flex flex-col items-center p-6">
                <h3 class="text-blue-500 p-4 md:text-3xl text-2xl font-extrabold max-md:text-center">
                  Signup as Artisans
                </h3>
                <form
                ...
                >
                  <div>
                    <label class="text-gray-800 text-xs mb-2">Full Name</label>
                  ...
                  <div class="mt-6">
                    <label class="text-gray-800 text-xs mb-2">Email</label>
                    <div class="relative flex items-center">
                      <input
                        name="email"
                        type="text"
                  ...
                  <div class="mt-6">
                    <label class="text-gray-800 text-xs mb-2">Password</label>
                    <div class="relative flex items-center">
                      <input
                        name="password"
                        type="password"
                  ...
                  <div class="mt-6">
                    <label class="text-gray-800 text-xs mb-2">About</label>
                    <div class="relative flex items-center justify-between">
                      <input
                        className=" w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none"
                        name="about"
                  ...
                  <div class="mt-6">
                    <label class="text-gray-800 text-xs mb-2">Experience</label>
                    <div class="relative flex items-center justify-between">
                      <input
                        type="number"
                        className=" w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none"
