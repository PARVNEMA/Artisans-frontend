...
function ArtisansPage() {
    ...
    <div>
      ...
      <div>
        <div class="flex max-lg:flex-col px-16 mx-8 my-8 gap-12 max-w-full flex-col ">
          ...
          <div class="grid md:grid-cols-2 gap-8 max-md:max-w-lg mx-auto ">
            <div class="text-left rounded-lg shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] p-6 bg-four">
              <svg
      ...
      {/* FAQ's */}
      <div className="mb-10 py-8 mx-[6rem] shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] bg-white rounded-lg">
        <div class="p-4">
