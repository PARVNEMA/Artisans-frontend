...
function ArtisansPage() {
  return (
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-md:max-w-lg mx-auto ">
          <div class="text-left rounded-lg shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] p-6 bg-four bg-opacity-70">
            ...
            <p class="text-three text-sm leading-relaxed">
              Offer you skill to people who love it! Create your Portfolio ,
              show your skill and create custimoize product according to the
          ...
          <div class="text-left rounded-lg shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] p-6 bg-four bg-opacity-60">
            ...
            >
              <defs>
                <clipPath id="a" clipPathUnits="userSpaceOnUse">
                  <path d="M0 512h512V0H0Z" data-original="#ffffff" />
                </clipPath>
              </defs>
              <g
                fill="none"
            ...
            <h3 class="text-black text-xl font-semibold mt-6 mb-3">Security</h3>
            <p class="text-three text-sm leading-relaxed">
              Reach out to verified artist ! keep upto date wiht your products
              creation throuhgt excclusive chat and have you payment securd by
              indian post
            </p>
          ...
          <div class="text-left  rounded-lg shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] p-6 bg-four bg-opacity-60">
            ...
            <h3 class="text-black text-xl font-semibold mt-6 mb-3">Support</h3>
            <p class="text-three text-sm leading-relaxed">
              Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla
              officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad
      ...
      {/* FAQ's */}
      <div className="mb-10 py-8 px-6 lg:px-16 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] bg-one bg-opacity-90 rounded-lg">
        {" "}
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                <p className="text-sm text-two">
                  {" "}
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                  do eiusmod tempor incididunt ut labore et aliqua.{" "}
                </p>{" "}
              </div>{" "}
            </div>{" "}
            <div>
