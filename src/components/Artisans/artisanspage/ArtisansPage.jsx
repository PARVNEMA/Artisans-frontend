		...
		<div>
			...
			<div className="flex bg-one ">
				<div className="h-auto w-full gap-3 flex flex-col justify-center items-center p-16">
					...
					<p className="text-center text-wrap text-lg text-three">
						Reach the right customer for your art !!
					</p>

					<Link
						to={"/artisans/signup"}
						className="bg-three h-[2rem] p-6 rounded-3xl text-one flex items-center"
					>
			...
			<div className="mb-10">
				<div class="p-4 font-sans">
					<div class="max-w-6xl mx-auto font-sans">
						<div>
							<h2 class="lg:text-4xl text-3xl font-bold text-gray-700">
