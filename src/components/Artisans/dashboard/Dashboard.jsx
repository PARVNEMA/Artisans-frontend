...
function Dashboard() {
  {
    ...
    const getArtisansProduct = useCallback(async () => {
      try {
        const res = await axios.get(`${backendurl}/products/myProducts`, {
    ...
    }, [artisans, getArtisansProduct, getArtisansSellerMetrices]);
    ...
    return (
      <div>
        ...
        <div className="mx-[10rem] text-start">
          <div className="text-3xl text-center p-8">Your Products</div>
          {artisansproducts.map((product) => (
            <div className="flex justify-between items-center p-4 border rounded-lg m-2 flex-col lg:flex-row">
              ...
              <div className="flex flex-col justify-between">
                <h2 className="text-2xl uppercase"><b>Title:</b> {product.title}</h2>
                <p className="text-lg uppercase"><b>Category:</b> {product.category.name}</p>
              </div>
              <p className="text-xl"><b className="uppercase">Description:</b> {product.description}</p>
              <div className="text-xl">
                <p><b className="uppercase">Stock:</b> {product.stockQuantity}</p>
                <p><b className="uppercase">Sales:</b> {product.sales}</p>
                <p><b className="uppercase">Views:</b> {product.views}</p>
              </div>
