...
function Dashboard() {
  {
    ...
    const getCurrentArtisans = useCallback(async () => {
      try {
        const res = await axios.get(`${backendurl}/artisans/detail`, {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${localStorage.getItem(
              "artisansaccessToken"
        ...
        console.log("res in getcurrent artisans details =", res.data);
    ...
    const deleteProduct = useCallback(async (productId) => {
      try {
        ...
        const res = await axios.delete(`${backendurl}/products/${productId}`, {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${localStorage.getItem(
              "artisansaccessToken"
