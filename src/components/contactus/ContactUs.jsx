...
function ContactUs() {
  return <div className="mb-6">
    <div
            class="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[500px] before:bg-blue-400 before:h-full max-md:before:hidden">
            <div>
