			...
			<div class="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[500px] before:bg-three before:bg-opacity-70 before:h-full max-md:before:hidden">
				<div>
					...
					<p class="text-sm text-gray-500 mt-4 leading-relaxed">
						Have a specific inquiry or looking to explore
						new opportunities? Our experienced team is ready
						to engage with you.
					</p>
					...
					<form>
						...
						<button
							type="button"
							class="mt-8 flex items-center justify-center text-sm w-full rounded-md px-6 py-3 bg-three  text-white hover:bg-opacity-50 bg-opacity-90"
						>
							<svg
				...
				<div class="z-10 relative left-[11rem] w-[300px] h-[400px] max-md:min-h-[650px] bg-one">
					<iframe
						src="https://maps.google.com/maps?q=jabalpur&t=&z=13&ie=UTF8&iwloc=&output=embed"
						class="left-0 top-0 h-full w-full rounded-lg lg:rounded-tr-none lg:rounded-bl-lg bg-one"
						frameborder="0"
						allowfullscreen
					></iframe>
				</div>
