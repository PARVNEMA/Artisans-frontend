...
function AddressForm() {
  ...
  useEffect(() => {
    getCountries();
    if (localStorage.getItem("artisansaccessToken")) setRole("Artisans");
  }, []);
  ...
  return (
    <div className="shadow-lg bg-white rounded-md max-md:max-w-lg m-8 md:grid-cols-2 items-center gap-8 max-w-4xl mx-auto py-10 px-8 lg:px-16">
