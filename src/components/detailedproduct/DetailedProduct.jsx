...
import { ArrowUpRightFromSquareIcon, IndianRupee, Star } from "lucide-react";
...
function DetailedProduct() {
  ...
  const getCurrentUser = useCallback(async () => {
    try {
      ...
      console.log("res in getcurrent artisans chatapp", res.data);
  ...
  return (
    <div>
      <div className="flex flex-col items-center">
        <div className="max-w-[85.25rem] md:px-[1.25rem] gap-[2.88rem] flex w-full flex-col">
          <div>
            <div class="pt-4 max-w-8xl max-md:max-w-xl">
              <div class="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
                <div class="w-full top-0 flex gap-3">
                  <div className="custom-carousel flex gap-3">
                    <div className="carousel-thumbs flex flex-col gap-3">
                      {" "}
                      {product.images.map((image, index) => (
                        <img
                          ...
                          className={`h-20 cursor-pointer rounded-lg border-2 object-cover ${
                            currentIndex === index
                              ? "border-gray-500"
                              : "border-transparent"
                          }`}
                    ...
                    <div className="carousel-image flex justify-center relative mb-4">
                      {" "}
                      <img
                        src={product.images[currentIndex]}
                        alt={`Product ${currentIndex + 1}`}
                        className="rounded-lg h-[40rem] w-[40rem] object-cover"
                      />{" "}
                    ...
                    <div className="flex justify-start mt-8 gap-10 items-center">
                      <div>
                        <h1 className="text-2xl font-semibold">
                          Created By: {product?.createdBy?.username}
                        </h1>
                        ...
                        <div>
                          ...
                          <Link to={"/login"}>
                            <div className="text-xl font-semibold font-sans mt-4">
                              <h2>LOGIN TO ADD YOUR REVIEW</h2>
                            </div>
                          </Link>
                        </div>
                      )}
