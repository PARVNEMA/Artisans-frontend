	...
	return (
		<div id="home" className="bg-four">
			...
			<div class="mb-12 max-w-full  mt-8 mx-[6rem]">
				<h2 class="text-three sm:text-4xl text-2xl font-extrabold text-center mb-16">
					Discover Our Exclusive Features
				</h2>
				<div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-6">
					<div class="p-6 flex gap-6 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 bg-one">
						<img
					...
					<div class="p-6 flex gap-6 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 bg-one">
						...
						<div>
							...
							<p class="text-three text-md font-semibold">
								Experience the taste of Indian season
								through highly curated seasonal
					...
					<div class="p-6 flex gap-6 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 bg-one">
						...
						<div>
							...
							<p class="text-three text-md font-semibold">
								Buy products with ease in any currency
								through our multi-currency system.
							</p>
						</div>
					</div>
					...
					<div class="p-6 flex gap-6 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 bg-one">
						...
						<div>
							...
							<p class="text-three text-md font-semibold">
								...
								appreciate your art, and create valuable
								products with your skill set.
							</p>
						</div>
					</div>
					...
					<div class="p-6 flex gap-6 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 bg-one">
						...
						<div>
							...
							<p class="text-three text-md font-semibold">
								Tailor our products to suit your needs with
