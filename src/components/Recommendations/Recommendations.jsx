...
function Recommendations() {
  ...
  const getAllFeaturedProducts = async () => {
    ...
    console.log("res in recommended pawan list =", res.data);
  ...
  const getAllRecommendedProducts = async () => {
    ...
    console.log("res in recommended products list", res.data);
  ...
  const recommendedProducts = catproducts.filter((catproduct) =>
    wishlist.some(
      (item) =>
        catproduct.category._id === item.productId.category &&
