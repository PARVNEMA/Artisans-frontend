	...
	const onSubmit = async (data) => {
		try {
			const res = await axios.post(
				`${backendurl}/admin/nastrigo/create`,
				data,
				{
			...
			console.log(
				"res from admin  register backend",
				res.data
			);
			// navigate("/");
					...
					<div class="">
						<div class="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] bg-white max-w-6xl max-md:max-w-lg m-4 rounded-md p-6 grid md:grid-cols-2 items-center gap-8 h-auto">
							<div class="max-md:order-1 p-4 bg-white h-full">
								<img
									src="https://images.pexels.com/photos/965879/pexels-photo-965879.jpeg?auto=compress&cs=tinysrgb&w=600"
